...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO  approval  VALUES ('$s_no', '$employee_name','$leave_type', '$apply_date', '$start_date', '$end_date',)";
    $result = mysqli_query($conn, $sql);

    if($result) {
        header("Location: approval.php?msg=New record added successfully");
    }
    else
    {
...
<div class="container d-flex justify-content-center">
    ...
    <div class="row">
        ...
        <div>
            ...
            <a href="approval.php" class="btn btn-danger"> back </a>
        </div>
</form>
</div>
</div>
